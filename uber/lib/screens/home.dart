            ...
            child: ListView(
              children: [
                UserAccountsDrawerHeader(
                    ...
                    accountName: Text(userProvider.userModel.name ?? "Empty user name",style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.normal,
                        color: Colors.white
                    ),
                    ),
                    accountEmail: Text( userProvider.userModel.email ?? "This is null",style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.normal,
                        color: Colors.white
                    ),
                ...
                ListTile(
                  ...
                  title: CustomText(text: "Perfil de usuario"),
                  onTap: () {
                  },
                ),
                ...
                ListTile(
                  ...
                  title: CustomText(text: "Relatorio"),
                  onTap: () {
                ...
                ListTile(
                  ...
                  title: CustomText(text: "Sobre a Camizage"),
                  onTap: () {
                ...
                ListTile(
                  ...
                  title: CustomText(text: "Terminar secção"),
                  onTap: () {
...
// For me
  ...
  double buttonPaddingMap = 0;

  void locatorPosition() async {
  ...
  Widget build(BuildContext context) {
    AppStateProvider appState = Provider.of<AppStateProvider>(context);
    UserProvider userProvider = Provider.of<UserProvider>(context);
    //print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA ${appState.center}");
    return appState.center == null ? Loading() : Stack(
      children: <Widget>[
        GoogleMap(
          initialCameraPosition: CameraPosition(target: appState.center, zoom: 15),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    TextButton(
                        onPressed: () {},
                        child: CustomText(
                          text: "\$${appState.routeModel?.distance.value == null ? 0 : appState.routeModel!.distance.value! / 500}" ??
                              "",
