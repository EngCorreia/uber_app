                    ...
                    children: [
                      Container(
                        ...
                        child: TextButton.icon(
                            onPressed: () {
                              //TODO
                              //scaffoldState.currentState.showSnackBar(SnackBar(content: Text("Method not available!")));
                            },
                                                ...
                                                children: [
                                                  TextButton(
                                                      onPressed: () {
                                                        ...
                                                        scaffoldState.currentState!.showBottomSheet(SnackBar(content: Text("Request cancelled!")) as WidgetBuilder);
                                                      },
                                                      child: CustomText(
                                                        text: "Cancel Request",
                                                        color:
